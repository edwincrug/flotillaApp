...
// -- Fecha: 
// -- =============================================
registrationModule.controller("expedienteController", function ($scope, $rootScope, $ionicPopup, $ionicModal, $cordovaCamera, expedienteRepository, $cordovaDatePicker) {
    ...
    $scope.getLocalRolDocuments = function () {
        ...
        expedienteRepository.getLocalRolDocuments($rootScope.vin, $rootScope.data.idRol).then(function (response) {
            ...
            for (var i = 0; i < $scope.localDocuments.length; i++) {
                if ($scope.localDocuments[i].idDocumento == $scope.localDocuments[25].valor) {
