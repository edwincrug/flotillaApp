...
$cordovaSQLite.execute($rootScope.FlotillasDB, 'CREATE TABLE IF NOT EXISTS LicitacionUnidad (vin TEXT NOT NULL PRIMARY KEY,' + 'factura TEXT,' + 'idLicitacion INTEGER,' + 'tipo TEXT,' + 'marca TEXT,' + 'modelo TEXT,' + 'estatus TEXT,' + 'usuarioAsignado INTEGER)');
